package com.example.cherry.mobile4;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEtIndex = (EditText) findViewById(R.id.et_delete);
        ...
        mBtDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                removeData(Integer.parseInt(index));
            }
        });
        ...
        mBtUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String index = mEtIndex.getText().toString();
                String name = mEtName.getText().toString();
                updateData(Integer.parseInt(index), name);
            }
        });
...
//            Toast.makeText(this, "index= " + id + " name=" + name, Toast.LENGTH_LONG).show();
    ...
    // 모든 Data 읽기
    public void selectAll() {   //쿼리 : 필드의 데이터를 리턴한다 즉 요구한다?
        // select는 쿼리야. 데이터를 리턴해.
        // 나머지는 명령어야. delete, update, ...
        String sql = "select * from " + tableName + " order by id desc;"; // 여기에다가 무슨 쿼리를 검색해서 달면 돼. orderby?
